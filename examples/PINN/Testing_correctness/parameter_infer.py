...
def glv_pde_with_unknown_perturbation(t, y, trainable_params, num_species, s_M, s_eps, lambda_pde):
    ...
    for i in range(num_species):
        ...
        # Multiply the residual by lambda_pde to weight the PDE loss
...
def infer_parameters_from_file(sim_file):
    ...
    # These are the scattered data points (for each species).
    ...
    # Combine all BCs: the supervised scattered data and the auxiliary ones.
    ...
    # For M, guess in the original scale then multiply by s_M
